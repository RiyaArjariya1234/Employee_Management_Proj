...
function EmployeeViewTaggedProject() {
  ...
  const fetchApprovedRequests = (employeeId) => {
    axios
      .get(`http://localhost:8182/api/request/approved/${employeeId}`)
      .then((response) => {
...
export default EmployeeViewTaggedProject;
